...
class OfficeSuppliesPage extends StatefulWidget {
  final CollectionReference _productRef= FirebaseFirestore.instance.collection("OfficeProducts");
  @override
  _OfficeSuppliesPageState createState() => _OfficeSuppliesPageState();
}

class _OfficeSuppliesPageState extends State<OfficeSuppliesPage> {
  @override
